...
Cuando un estudiante abandona un simulacro sin finalizarlo, el **Reaper** lo cierra automáticamente al expirar el tiempo. Debe ejecutarse cada 5 minutos.
...
El Reaper corre automaticamente via un loop background en el contenedor backend (sin cron, sin configuracion adicional).
