...
=========================================
Usa Anthropic Claude Opus 4.8 con visión para analizar y corregir gráficos SVG
...
class GraficoOptimizer:
    """
    Optimizador de gráficos SVG usando Claude Opus 4.8.
    ...
    def optimizar(
        ...
        if not CLAUDE_API_KEY:
            ...
            if openai_key:
                print(" No se encontró CLAUDE_API_KEY, intentando con OpenAI como fallback...")
        ...
        try:
            ...
            print(f" Optimizando gráfico SVG con Claude Opus 4.8...")
            print(f"   Área: {area}")
            ...
            # Obtener contenido de la respuesta (filtrar bloques de texto)
            text_blocks = [b for b in message.content if getattr(b, "type", None) == "text"]
            if not text_blocks:
                raise ValueError("No se encontró bloque de texto en la respuesta de Claude")
