...
"""
    ...
    def _generar_pipeline_sociales_ciudadanas(
        ...
        # Competencias segun marco oficial ICFES:
        # 30% Pensamiento social, 40% Interpretacion, 30% Pensamiento reflexivo y sistemico.
        total_p_social = int(target_preguntas * 0.30)
        total_p_reflexivo = int(target_preguntas * 0.30)
