...
async def optimizar_grafico(
    ...
    if "imagen_base64" in request:
        print(f"    Tamaño imagen: {len(request['imagen_base64'])} caracteres")
    else:
    ...
    if not svg_spec_actual:
        ...
        if config_grafico.get("svg_code"):
            print(f"    No hay svg_spec, pero hay svg_code. Reconstruyendo desde imagen...")
            svg_spec_actual = {
                "viewBox": "0 0 400 300",
                "shapes": [],
        ...
        # Caso 2: Chart.js (datasets)
            ...
            print(f"    Es un gráfico Chart.js. Reconstruyendo desde imagen...")
            svg_spec_actual = {
                "viewBox": "0 0 400 300",
                "shapes": [],
        ...
        # Caso 4: descripcion_visual (svg_artistico pendiente de generar)
            ...
            print(f"    Hay descripcion_visual pero no svg_code. Generando desde imagen...")
            svg_spec_actual = {
                "viewBox": "0 0 400 300",
                "shapes": [],
