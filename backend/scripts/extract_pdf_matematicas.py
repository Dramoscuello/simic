"""
Script para extraer texto de los PDFs de Matemáticas
...
AREA_DIR = os.path.join(BASE_DIR, "static", "matematicas")
...
PDF_FILES = {
    "marco_referencia_matematicas.pdf": "marco_referencia_matematicas.txt",
    "niveles_desempeno_matematicas.pdf": "niveles_desempeno_matematicas.txt",
    "patron_simulacro_matematicas_001.pdf": "patron_simulacro_matematicas.txt",
}
...
def main():
    print("="*60)
    print(" Extracción de PDFs - MATEMÁTICAS")
    print("="*60)
