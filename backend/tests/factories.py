...
def create_reporte_grupal(
    db: Session,
    simulacro: Simulacro,
    institucion: Institucion,
    informe_contenido: str = "Contenido de reporte grupal",
    estadisticas_agregadas: dict | None = None,
    **kwargs,
) -> ReporteGrupal:
    if estadisticas_agregadas is None:
        estadisticas_agregadas = {
            "tipo_reporte": "grupal_numerico",
            "average_score_100": 75.0,
            "min_score_100": 60.0,
            "max_score_100": 90.0,
            "students_count": 5,
            "performance_level": "Alto",
            "performance_interval": "70-80",
            "generated_at": datetime.now(timezone.utc).isoformat(),
            "institution_name": institucion.nombre,
            "area": simulacro.area,
            "area_display": simulacro.area,
            "students": []
        }
    ...
    grup = ReporteGrupal(
        simulacro_id=simulacro.id,
        institucion_id=institucion.id,
        informe_contenido=informe_contenido,
